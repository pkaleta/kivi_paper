...
Regarding source code, the only complicated bit is in the \texttt{collectExpr}
function when collecting supercombinators from \texttt{let(rec)} expressions.
There are three possibilities where we should collect supercombinators from:
