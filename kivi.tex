...
\begin{lstlisting}[caption={\texttt{push} and \texttt{pop} operations on the
  LLVM stack.}]
...
\begin{lstlisting}[caption={Definition of function allocating number node on
  the heap.}]
...
node on the heap and later push the address of that node on stack. Each
variable defined has unique suffix because of static single assignment feature
of LLVM IR.
