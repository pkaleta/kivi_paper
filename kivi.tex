...
one that I'll be particularly interested in is called \textit{parametric
...
\begin{itemize}
  ...
  \item \textit{implicit parametric polymorphism} on the other hand, occurs
    ...
    contain type variables, which are 'holes' to be later filled with certain
    types.
\end{itemize}
