...
There are few types that are considered as built-ins. These are lists, tuples,
and booleans.
...
the bound is set to 5. This means that programmer is not allowed to create
tuples that contain more than 5 elements. This design decision is due to the
fact that from my perspective it's better to use custom Structured Data Type
for readability reasons. The limit of 5 however, is an experimental value and
might be changed.
